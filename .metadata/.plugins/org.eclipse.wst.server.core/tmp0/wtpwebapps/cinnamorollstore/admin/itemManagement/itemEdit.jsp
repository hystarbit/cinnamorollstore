			...
			<div class="item-info">
				...
				<form class="order-user-info" method="post" enctype="multipart/form-data"
					...
					<table class="order-info-table">
							...
							<td class="table-right">
								<div class="dropdown">
									<button class="order-button dropdown-toggle" type="button"
										data-bs-toggle="dropdown" aria-expanded="false">${item.category }</button>
						...
						<tr>
							...
							<td class="table-right"><input type="file" id="uploadFile"
								name="uploadFile" accept="image/*" style="background: white;">
							</td>
						</tr>
					</table>
					<br>
					...
					<div class="product-exposure">
						<div>
							<input type="radio" id="display" value="진열" name="exposure" checked> <label
