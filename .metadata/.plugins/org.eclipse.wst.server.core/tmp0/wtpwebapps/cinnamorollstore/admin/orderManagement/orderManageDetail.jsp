		...
		<div class="mypage-main">
			...
			<div class="item-info">
				...
				<form class="order-user-info" method="post" id="statusForm"
					enctype="multipart/form-data" action="${path}/admin/order/detail/edit.do">
					<input type="hidden" name="order_number" value="${order.order_number }">
					<input type="hidden" id="selectedPaymentStatus"
						name="payment_status" value="${order.payment_status }"> 
					<input type="hidden" id="selecedOrderStatus" name="order_status"
								...
								<td class="table-right border-free">
									...
									<ul class="dropdown-menu" style="min-width: 50px;">
										<li><a class="dropdown-item o" href="#"
											onclick="selectValue('selecedOrderStatus','주문 확인 전')">주문
												확인 전</a></li>
										<li><a class="dropdown-item o" href="#"
											onclick="selectValue('selecedOrderStatus','주문 확인')">주문
												확인</a></li>
										<li><a class="dropdown-item o" href="#"
											onclick="selectValue('selecedOrderStatus','배송 준비 중')">배송
												준비 중</a></li>
										<li><a class="dropdown-item o" href="#"
											onclick="selectValue('selecedOrderStatus','배송 중')">배송
												중</a></li>
										<li><a class="dropdown-item o" href="#"
											onclick="selectValue('selecedOrderStatus','배송 완료')">배송
												완료</a></li>
									</ul>
								</td>
								<td class="table-left black border-free"></td>
								<td class="table-left border-free">
									<button class="order-check" style="width: 100px;">교환
										진행</button>
								</td>
							</tr>
							<tr>
								...
								<td class="table-right border-free">
									<button class="order-button dropdown-toggle" id="company"
										type="button" data-bs-toggle="dropdown" aria-expanded="false">택배
										회사</button>
									<ul class="dropdown-menu" style="min-width: 50px;">
										<li><a class="dropdown-item c" href="#">우체국</a></li>
										<li><a class="dropdown-item c" href="#">한진</a></li>
										<li><a class="dropdown-item c" href="#">롯데</a></li>
										<li><a class="dropdown-item c" href="#">로젠</a></li>
										<li><a class="dropdown-item c" href="#">CJ 대한통운</a></li>
									</ul>
								</td>
								
								<td class="table-right border-free" colspan="3">
									<form role="search">
										<input type="search" style="width: 300px">
										<button class="order-check"
											style="width: auto; margin-left: 5px;">배송조회</button>
									</form>
								</td>
								<td class="table-left border-free">
									<button class="order-check" style="width: 100px;">주문
										취소하기</button>
								</td>
							</tr>
						</table>
