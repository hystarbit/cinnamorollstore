...
<body>
	<div id="wrap">
		...
		<form id="writeBoardForm" class="order-user-info" method="post"
					action="${path }/customer/board/write.do">
		<div class="item-info">
			<h2><input type="text" maxlength="30" placeholder="제목을 입력하세요(30자 이내)" name="title" required></h2>
			<hr>
			<div style="height:400px;">
				<textarea maxlength="1000" name="content" placeholder="내용을 입력하세요(1000자 이내)"
				style="resize:none; height:400px; width:980px;" ></textarea>
			</div>
			<br>
			<br>
	...
	<script>
		function registForm(){
			/* alert("게시글 등록되었습니다."); */
			document.getElementById('writeBoardForm').submit();
		}
