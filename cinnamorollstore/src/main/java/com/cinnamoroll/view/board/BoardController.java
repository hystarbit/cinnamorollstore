...
public class BoardController {
	...
	@RequestMapping(value = "/customer/reply/write.do", produces = "application/text; charset=UTF-8" )
	@ResponseBody
	public String replyWrite(@RequestParam String board_number, 
			@RequestParam String user_id, 
			@RequestParam String content, ReplyVO vo) throws JsonProcessingException {
	...
	@RequestMapping(value="/customer/reply/edit.do", produces = "application/text; charset=UTF-8" )
	@ResponseBody
	public String replyEdit(@RequestParam String reply_number,
										@RequestParam String content,
										ReplyVO vo) throws JsonProcessingException{
		int replyNumber = Integer.parseInt(reply_number);
	...
	@ResponseBody
	public String replyDelete(@RequestParam String reply_number,
										ReplyVO vo) throws JsonProcessingException{
		int replyNumber = Integer.parseInt(reply_number);
		vo.setReply_number(replyNumber);
